...
public class Instantiation implements CommandLineRunner {
	...
	// Fazer operação com bando de dados
	@Autowired
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c3 = new CommentDTO("Tenha um ótimo dia, Fluminense será campeão da Libertadores!", sdf.parse("23/03/2018"), new AuthorDTO(alex));
